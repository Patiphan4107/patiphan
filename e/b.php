...
<?php
		...
		$sql = "INSERT INTO application (a_id,a_position,a_prefix,a_fullname,a_birthdate,a_education,a_skill,a_experience) values
(NULL, '{$position}', '{$prefix}' ,'{$fullname}', '{$birthdate}', '{$education}', '{$skill}', '{$experience}');";
