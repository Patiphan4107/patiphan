        ...
        <div class="col-lg-10 form-container">
            ...
            <div class="mt-4 p-3 bg-light rounded">
                ...
                if(isset($_POST['Submit'])){
                    ...
                    echo "<p><strong>สีที่ชอบ:</strong> $color <span style='display:inline-block; width:20px; height:20px; background-color:$color; border: 1px solid #ccc; vertical-align:middle; margin-left:5px;'></span></p>";
